...
<script>
    ...
    function toggleDoctypeDropdown(e) {
        ...
        // Position flyout directly under the button using fixed coords
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // ── PAU / BGCU flyout items (modal unit picker) ──────────────────────
        ...
        // ── Filter bar: option click (includes PAU/BGCU with flyouts) ────────
        document.querySelectorAll('[data-filter-unit-option]').forEach(option => {
            option.addEventListener('click', () => {
                ...
                // If this option has a flyout, show it instead of selecting immediately
                const flyoutKey = option.dataset.hasFlyout;
                if (flyoutKey) {
                    // Flyout positioning is handled by mouseenter on the option row
                    // Clicking PAU/BGCU itself selects the parent unit
                }
